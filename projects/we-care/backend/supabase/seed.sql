...
INSERT INTO referrals (
  ...
  (
    ...
    'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb1',
    'cccccccc-cccc-cccc-cccc-ccccccccccc1',
    'Progressive exertional dyspnea with intermittent chest tightness. Request cardiology evaluation and stress testing.',
  ...
  (
    ...
    'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb2',
    'cccccccc-cccc-cccc-cccc-ccccccccccc2',
    'Chronic migraines not responding to first-line therapy. Neurology consult requested for treatment escalation.',
  ...
  (
    ...
    'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb4',
    'cccccccc-cccc-cccc-cccc-ccccccccccc3',
    'Changing irregular pigmented lesion with recent itching. Dermatology assessment for biopsy recommended.',
  ...
  (
    ...
    'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb3',
    'cccccccc-cccc-cccc-cccc-ccccccccccc4',
    'Severe right knee osteoarthritis with ongoing pain and mobility limitation. Orthopedic consultation requested.',
  ...
  (
    ...
    'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb5',
    'cccccccc-cccc-cccc-cccc-ccccccccccc5',
    'Anxiety symptoms and insomnia impacting daily function. Psychiatry consult requested for medication review.',
  ...
  (
    ...
    'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb6',
    'cccccccc-cccc-cccc-cccc-ccccccccccc6',
    'Unintentional weight loss with fatigue and abnormal labs. Oncology workup requested.',
