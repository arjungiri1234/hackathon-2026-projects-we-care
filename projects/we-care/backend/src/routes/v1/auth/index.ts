...
import { signUp, signIn, signOut, forgotPassword, resetPassword } from '../../../services/auth.service';
...
router.post('/signup', async (req: Request, res: Response) => {
  ...
  res.status(201).json({ message: 'Doctor registered successfully', user: data.user });
});
...
router.post('/signout', authMiddleware, async (req: AuthRequest, res: Response) => {
